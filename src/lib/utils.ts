import { S3File, S3Directory } from './s3';
...
export function isEditableText(filename: string): boolean {
  const textExtensions = ['txt', 'md', 'json', 'xml', 'yaml', 'yml', 'js', 'ts', 'jsx', 'tsx', 'html', 'css', 'scss', 'sass', 'php', 'py', 'java', 'cpp', 'c', 'cs', 'go', 'rs', 'rb', 'swift', 'kt', 'sql'];
...
export function s3DirectoryToDirectoryItem(directory: S3Directory): DirectoryItem {
  return {
    ...directory,
    id: generateId(),
  };
